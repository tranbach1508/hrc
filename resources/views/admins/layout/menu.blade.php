    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{Route('cate_new.list')}}"><i class="fa fa-circle-o"></i>Danh sách loại tin tức</a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{Route('cate_service.list')}}"><i class="fa fa-circle-o"></i>Danh sách loại dịch
                            vụ</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{Route('infor_company.list')}}"><i class="fa fa-circle-o"></i>Thông tin công ty</a>
                    </li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Tư vấn</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{Route('ad_re.list')}}"><i class="fa fa-circle-o"></i>E-learning</a></li>
                    <li><a href="{{Route('ad_re.add')}}"><i class="fa fa-circle-o"></i> Thêm thông tin e-learning</a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Tư vấn con</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{Route('sub_ad_re.list')}}"><i class="fa fa-circle-o"></i>Sub-e-learning</a></li>
                    <li><a href="{{Route('sub_ad_re.add')}}"><i class="fa fa-circle-o"></i> Thêm thông tin
                            Sub-e-learning</a></li>
                </ul>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Tin tuyển dụng</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{Route('recruitment.list')}}"><i class="fa fa-circle-o"></i>Danh sách</a></li>
                    <li><a href="{{Route('recruitment.add')}}"><i class="fa fa-circle-o"></i>Thêm tin</a></li>
                </ul>
            </li>

            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Loại khóa học</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{Route('cate_course.list')}}"><i class="fa fa-circle-o"></i>Danh sách</a></li>
                    <li><a href="{{Route('cate_course.add')}}"><i class="fa fa-circle-o"></i>Thêm loại khóa học</a></li>
                </ul>
            </li>

            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Khóa học</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{Route('course.list')}}"><i class="fa fa-circle-o"></i>Danh sách</a></li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>học viên</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{Route('registration.list')}}"><i class="fa fa-circle-o"></i>Danh sách</a></li>
                </ul>
            </li>
