    ...
    <div class="container-fluid">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                                <form role="form" method="POST" action="{{Route('recruitment.edit',['id'=>$recruitment->id])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nhập tóm tắt nội dung tin tuyển dụng" name="summary"
                                value="{{ $recruitment->summary }}">
                            <p style="color:red">{{ $errors->first('summary') }}</p>
                        </div>

                        <div class="form-group">
                            <label>Nội dung (*)</label>
                            <textarea name="content" id="desc" cols="30" rows="10">{{ $recruitment->content }}</textarea>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group" id="lastImg">
                            <div>
                                <img style="width:200px" src="{{asset('images/img_recruitment/'.$recruitment->image)}}" alt="">
                            </div>
                        </div>
                        <div class="form-group">
                            <div id="viewImg">
