        ...
        <section class="content">
            <div class="row">
                <div class="box-header">
                    <a href="{{route('course.list')}}" class="btn btn-primary">Danh sách</a>
                </div>
                <div class="col-xs-12">
                    <div class="box">
                        <form role="form" method="POST" action="{{route('course.add')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>Cấp độ (*)</label>
                                    <div class="radio">
                                        <label for=""><input type="radio" name="level" value="1">Đặc biệt</label>
                                    </div>
                                    <div class="radio">
                                        <label for=""><input type="radio" name="level" value="0">Thường</label>
                                    </div>
