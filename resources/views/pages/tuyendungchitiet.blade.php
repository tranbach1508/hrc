    ...
    <div class="container mb-5">
        ...
        <div class="row mt-5">
            <div class="col-md-9 mb-3">
                <h3 class="text-center mb-3">{{$recruitment_detail->title}}</h3>
                <div class="pt-3">
            ...
            <div class="col-md-3">
                <ul class="list-group ">
                    <li class="list-group-item tintuc-1 font-weight-bold text-center"> TIN TUYỂN DỤNG MỚI NHẤT</li>
                    @foreach($new_recruitment as $value)
                    <li class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col-md-8" style="padding: 0 10px; font-size: 14px">
                                <a href="{{ Route('tuyendungchitiet',['slug'=>$value->slug]) }}"
